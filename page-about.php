            ...
            <div class="row">
                <div class="large-1 columns large-offset-1 section-title-container">
                    <h3 class="section-title" style="margin-top: -10px;">
                        <?php echo wp_kses_post(get_post_meta(get_the_ID(), 'worldwide_about_title', true)); ?>
                    </h3>
                </div>
                <div class="columns large-4 small-6">
                    ...
                    <a href="http://tbwa.com" target="_blank" id="global-logo">
                        <img src="<?php echo esc_url($featured_image_url); ?>" loading="lazy"
                            alt="<?php echo wp_kses_post(get_post_meta(get_the_ID(), 'worldwide_about_title', true)); ?>" />
                    </a>
                </div>
                <div class="columns large-6 large-offset-1 end">
                    <div class="global-network-copy">
                        <?php echo wp_kses_post(get_post_meta(get_the_ID(), 'worldwide_about_content', true)); ?>
                    </div>
                </div>
            </div>
            <!--/.row-->
